...
namespace Nekos.SpecialtyPlugin.Watcher
{
      ...
      private void _onHarvesting(InteractableFarm harvestable, SteamPlayer player, ref bool shouldAllow)
      {
        ...
        if(plugin != null)
        {
          ...
          plugin.SkillUpdaterInstance.SumSkillExp(
            ...
            plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.AGRICULTURE_ONFARM),
            (byte)EPlayerSpeciality.SUPPORT,
            (byte)EPlayerSupport.AGRICULTURE
          );
        }
      }
    ...
    IEventListener<UnturnedResourceDamagingEvent>
  {
    ...
    public async Task HandleEventAsync(Object? obj, UnturnedZombieDamagingEvent @event)
    {
      ...
      if (plugin != null)
      {
        ...
        if (player != null && zombie != null) await Task.Run(() =>
        {
              ...
              case EItemType.GUN:
                {
                  ...
                  updater.SumSkillExp(
                    player,
                    _calculateDistExp(
                      config.GetEventUpdate(eSkillEvent),
                      dist,
                      config.GetEventUpdate(SkillConfig.ESkillEvent.SHARPSHOOTER_SHOOT_DIST_START),
                      config.GetEventUpdate(SkillConfig.ESkillEvent.SHARPSHOOTER_SHOOT_DIST_DIV)
                    ),
                    (int)EPlayerSpeciality.OFFENSE,
                    (int)EPlayerOffense.SHARPSHOOTER
                  );
                }
                break;
              ...
              case EItemType.GUN:
                {
                  ...
                  {
                    // outdoors
                    skillUpdater.SumSkillExp(
                      player,
                      skillConfig.GetEventUpdate(SkillConfig.ESkillEvent.OUTDOORS_ANIMAL_KILLED),
                      (byte)EPlayerSpeciality.SUPPORT,
                      (byte)EPlayerSupport.OUTDOORS
                    );
                  }
                  ...
                  skillUpdater.SumSkillExp(
                    player,
                    skillConfig.GetEventUpdate(eSkillEvent),
    ...
    public async Task HandleEventAsync(Object? obj, UnturnedVehicleDamagingTireEvent @event)
    {
      ...
      if (plugin != null)
      {
        ...
        if (player != null && player.Player.equipment.asset.type == EItemType.GUN) await Task.Run(() =>
        {
          // sharpshooter
          skillUpdater.SumSkillExp(
            player,
            skillConfig.GetEventUpdate(SkillConfig.ESkillEvent.SHARPSHOOTER_SHOOT_TIRE),
            (byte)EPlayerSpeciality.OFFENSE,
            (byte)EPlayerOffense.SHARPSHOOTER
          );
        });
    ...
    public async Task HandleEventAsync(Object? obj, UnturnedResourceDamagingEvent @event)
    {
      ...
      if (plugin != null)
      {
        ...
        if (@event.Instigator != null) await Task.Run(() =>
        {
        ...
        if(asset != null)
        {
          switch (asset.type)
          {
            ...
            case EItemType.FOOD:
              ...
              skillUpdater.SumSkillExp(
                @event.Player,
                skillConfig.GetEventUpdate(SkillConfig.ESkillEvent.COOKING_ON_COOK),
                (byte)EPlayerSpeciality.SUPPORT,
                (byte)EPlayerSupport.COOKING
              );
            ...
            case EItemType.COMPASS:
              ...
              skillUpdater.SumSkillExp(
                @event.Player,
                skillConfig.GetEventUpdate(SkillConfig.ESkillEvent.ENGINEER_CRAFTING),
                (byte)EPlayerSpeciality.SUPPORT,
                (byte)EPlayerSupport.ENGINEER
              );
            ...
            case EItemType.GROWER:
              ...
              skillUpdater.SumSkillExp(
                @event.Player,
                skillConfig.GetEventUpdate(SkillConfig.ESkillEvent.AGRICULTURE_CRAFTING),
                (byte)EPlayerSpeciality.SUPPORT,
                (byte)EPlayerSupport.AGRICULTURE
              );
            ...
            case EItemType.MEDICAL:
              ...
              skillUpdater.SumSkillExp(
                @event.Player,
                skillConfig.GetEventUpdate(SkillConfig.ESkillEvent.HEALING_CRAFTING),
                (byte)EPlayerSpeciality.SUPPORT,
            ...
            default:
              ...
              skillUpdater.SumSkillExp(
                @event.Player,
                skillConfig.GetEventUpdate(SkillConfig.ESkillEvent.CRAFTING_ON_CRAFT),
                (byte)EPlayerSpeciality.SUPPORT,
                (byte)EPlayerSupport.CRAFTING
              );

              // dexterity
              skillUpdater.SumSkillExp(
                @event.Player,
                skillConfig.GetEventUpdate(SkillConfig.ESkillEvent.DEXTERITY_CRAFTING),
                (byte)EPlayerSpeciality.OFFENSE,
      ...
      private async Task _async_onReloading(UseableGun gun)
      {
        ...
        if (plugin != null)
        {
          ...
          if(_mag_swap.TryGetValue(gun.player.GetNetId(), out KeyValuePair<UnturnedPlayer, byte> pair))
          {
            plugin.SkillUpdaterInstance.SumSkillExp(
              pair.Key,
              (float)(plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.DEXTERITY_RELOAD_PER_AMMO) * pair.Value),
              (byte)EPlayerSpeciality.OFFENSE,
              (byte)EPlayerOffense.DEXTERITY
            );
    ...
    IEventListener<UnturnedPlayerSpawnedEvent>
  {
    ...
    public async Task HandleEventAsync(Object? obj, UnturnedPlayerOxygenUpdatedEvent @event)
    {
      ...
      if (plugin != null)
      {
        if (_lastOxygen.TryGetValue(@event.Player.SteamId.m_SteamID, out Byteref dataref)) await Task.Run(() =>
        {
          ...
          if (_delta < 0)
          {
            ...
            plugin.SkillUpdaterInstance.SumSkillExp(
              @event.Player,
              (float)(plugin.SkillConfigInstance.GetEventUpdate(eSkillEvent) * _delta * -1),
              (byte)EPlayerSpeciality.OFFENSE,
              (byte)EPlayerOffense.DIVING
            );
          }
          else if (_delta > 0)
          {
            ...
            plugin.SkillUpdaterInstance.SumSkillExp(
              @event.Player,
              (float)(plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.CARDIO_OXYGEN_REGEN) * _delta),
              (byte)EPlayerSpeciality.OFFENSE,
              (byte)EPlayerOffense.CARDIO
            );
          }
    ...
    public async Task HandleEventAsync(Object? obj, UnturnedPlayerStaminaUpdatedEvent @event)
    {
      ...
      if (plugin != null)
      {
        if (_lastStamina.TryGetValue(@event.Player.SteamId.m_SteamID, out Byteref dataref)) await Task.Run(() =>
        {
          ...
          if (_delta < 0)
          {
            ...
            plugin.SkillUpdaterInstance.SumSkillExp(
              @event.Player,
              (float)(plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.EXERCISE_STAMINA_USE) * _delta),
              (byte)EPlayerSpeciality.OFFENSE,
              (byte)EPlayerOffense.EXERCISE
            );
            ...
            if (@event.Player.Player.stance.stance == EPlayerStance.SPRINT)
            {
              ...
              plugin.SkillUpdaterInstance.SumSkillExp(
                @event.Player,
                (float)(plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.PARKOUR_STAMINA_USE_SPRINTING) * _delta),
                (byte)EPlayerSpeciality.OFFENSE,
                (byte)EPlayerOffense.PARKOUR
              );
            }
          }
          else if (_delta > 0)
          {
            ...
            plugin.SkillUpdaterInstance.SumSkillExp(
              @event.Player,
              (float)(plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.CARDIO_STAMINA_REGEN) * _delta),
              (byte)EPlayerSpeciality.OFFENSE,
              (byte)EPlayerOffense.CARDIO
            );
          }
    ...
    public async Task HandleEventAsync(Object? obj, UnturnedPlayerFoodUpdatedEvent @event)
    {
      ...
      if(plugin != null)
      {
        ...
        if (_survivalValueMaintain.TryGetValue(@event.Player.SteamId.m_SteamID, out dataref))
        {
          ...
          {
            ValueMaintainer maintainer = new ValueMaintainer(
              @event.Player,
              0,
              SkillConfig.ESkillEvent.SURVIVAL_INCREASE_PERSEC_MULT,
              EPlayerSpeciality.DEFENSE,
              (byte)EPlayerDefense.SURVIVAL
            );
            ...
            if (@event.Food > plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.VITALITY_MAINTAIN_HUNGER_ABOVE))
            {
              ...
              if(dataref.data == (_foodflag | _thirstflag))
              {
                ValueMaintainer maintainer = new ValueMaintainer(
                  @event.Player,
                  0,
                  SkillConfig.ESkillEvent.VITALITY_INCREASE_PERSEC_MULT,
                  EPlayerSpeciality.DEFENSE,
                  (byte)EPlayerDefense.VITALITY
                );
      ...
      if(plugin != null)
      {
        if (_lastVirus.TryGetValue(@event.Player.SteamId.m_SteamID, out Byteref dataref))
        {
          ...
          if(_delta < 0)
          {
            ...
            plugin.SkillUpdaterInstance.SumSkillExp(
              @event.Player,
              (float)(plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.IMMUNITY_VIRUS_DECREASE_MULT) * _delta),
              (byte)EPlayerSpeciality.DEFENSE,
              (byte)EPlayerDefense.IMMUNITY
            );
          }
          else if(_delta > 0)
          {
            plugin.SkillUpdaterInstance.SumSkillExp(
              @event.Player,
              (float)(plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.IMMUNITY_VIRUS_INCREASE_MULT) * _delta),
              (byte)EPlayerSpeciality.DEFENSE,
              (byte)EPlayerDefense.IMMUNITY
            );
          }
      ...
      if(plugin != null)
      {
        if (_lastHealth.TryGetValue(@event.Player.SteamId.m_SteamID, out Byteref dataref))
        {
          ...
          if (_delta < 0)
          {
            ...
            plugin.SkillUpdaterInstance.SumSkillExp(
              @event.Player,
              (float)(plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.TOUGHNESS_HEALTH_DECREASE_MULT) * _delta),
              (byte)EPlayerSpeciality.DEFENSE,
              (byte)EPlayerDefense.TOUGHNESS
            );

            // strength
            plugin.SkillUpdaterInstance.SumSkillExp(
              @event.Player,
              (float)(plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.STRENGTH_HEALTH_DECREASE_MULT) * _delta),
              (byte)EPlayerSpeciality.DEFENSE,
              (byte)EPlayerDefense.STRENGTH
            );
          }
          else if (_delta > 0)
          {
            ...
            else
            {
              plugin.SkillUpdaterInstance.SumSkillExp(
                @event.Player,
                (float)(plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.HEALING_HEALTH_MULT) * _delta),
                (byte)EPlayerSpeciality.SUPPORT,
                (byte)EPlayerSupport.HEALING
              );
            }
    ...
    public async Task HandleEventAsync(Object? obj, UnturnedPlayerBleedingUpdatedEvent @event)
    {
      ...
      if(plugin != null && @event.IsBleeding)
      {
        ...
        plugin.SkillUpdaterInstance.SumSkillExp(
          @event.Player,
          (float)plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.TOUGHNESS_BLEEDING),
          (byte)EPlayerSpeciality.DEFENSE,
          (byte)EPlayerDefense.TOUGHNESS
        );
        ...
        plugin.SkillUpdaterInstance.SumSkillExp(
          @event.Player,
          (float)plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.STRENGTH_BLEEDING),
          (byte)EPlayerSpeciality.DEFENSE,
          (byte)EPlayerDefense.STRENGTH
        );
      }
    ...
    public async Task HandleEventAsync(Object? obj, UnturnedPlayerBrokenUpdatedEvent @event)
    {
      ...
      if(plugin != null && @event.IsBroken)
      {
        ...
        plugin.SkillUpdaterInstance.SumSkillExp(
          @event.Player,
          (float)plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.TOUGHNESS_FRACTURED),
          (byte)EPlayerSpeciality.DEFENSE,
          (byte)EPlayerDefense.TOUGHNESS
        );
        ...
        plugin.SkillUpdaterInstance.SumSkillExp(
          @event.Player,
          (float)plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.STRENGTH_FRACTURED),
          (byte)EPlayerSpeciality.DEFENSE,
          (byte)EPlayerDefense.STRENGTH
        );
      }
    ...
    public async Task HandleEventAsync(Object? obj, UnturnedPlayerFallDamagingEvent @event)
    {
      ...
      if(plugin != null)
      {
        ...
        plugin.SkillUpdaterInstance.SumSkillExp(
          @event.Player,
          (float)(plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.STRENGTH_HEALTH_DECREASE_FALL_DAMAGE_MULT) * @event.DamageAmount),
          (byte)EPlayerSpeciality.DEFENSE,
          (byte)EPlayerDefense.STRENGTH
        );
      }
  ...
  public class AlertWatcher :
    IEventListener<UnturnedZombieAlertingPlayerEvent>,
    IEventListener<UnturnedAnimalAttackingPlayerEvent>
  {
      ...
      if (plugin != null) await Task.Run(() =>
      {
        ...
        if (_dist < _maxdist)
        {
          ...
          plugin.SkillUpdaterInstance.SumSkillExp(
            ...
            (_maxdist - _dist) / _div,
            (byte)EPlayerSpeciality.DEFENSE,
            (byte)EPlayerDefense.SNEAKYBEAKY
          );
        }
      });
    }
  ...
  public class RepairingWatcher:
    IEventListener<UnturnedVehicleRepairingEvent>
  {
    public async Task HandleEventAsync(object? obj, UnturnedVehicleRepairingEvent @event)
    {
      ...
      if(plugin != null)
      {
        ...
        if(user != null)
        {
          ...
          plugin.SkillUpdaterInstance.SumSkillExp(
            user.Player,
            (float)(plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.MECHANIC_REPAIR_HEALTH) * @event.PendingTotalHealing),
            (byte)EPlayerSpeciality.SUPPORT,
            (byte)EPlayerSupport.MECHANIC
          );

          // engineer
          plugin.SkillUpdaterInstance.SumSkillExp(
            user.Player,
            (float)(plugin.SkillConfigInstance.GetEventUpdate(SkillConfig.ESkillEvent.ENGINEER_REPAIR_HEALTH) * @event.PendingTotalHealing),
            (byte)EPlayerSpeciality.SUPPORT,
            (byte)EPlayerSupport.ENGINEER
          );
        }
